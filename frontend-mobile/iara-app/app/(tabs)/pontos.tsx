...
const LOCAIS = [
  {
    ...
    description: 'Onde entregar doações e materiais de apoio',
  ...
  },
  {
    route:       '/abrigos',
    title:       'Abrigos',
    description: 'Locais de acolhimento para pessoas desabrigadas',
  ...
  },
  {
    route:       '/hospitais',
    title:       'Hospitais',
    description: 'Unidades de saúde e leitos disponíveis',
  ...
  },
  {
    ...
    description: 'Infraestrutura de suporte da Defesa Civil',
