...
import br.com.iara.iara_api.dto.auth.MobileRegisterRequest;
...
public class MobileAuthController {
    ...
    public ResponseEntity<TokenResponse> login(@Valid @RequestBody LoginRequest req,
        ...
        return ResponseEntity.ok(authService.loginMobile(req, resolveClientIp(httpRequest)));
    }

    @PostMapping("/register")
    public ResponseEntity<TokenResponse> register(@Valid @RequestBody MobileRegisterRequest req) {
        return ResponseEntity.status(HttpStatus.CREATED).body(authService.registerMobile(req));
    }
